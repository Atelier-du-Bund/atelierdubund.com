...
- **The Founding Collection opens on the Maximilian.** Changed 2026-08-20: a referred
  ...
  tab in the markup, the `let style = 'maximilian'` initialiser, and the
  `setStyle('maximilian')` call at the end of the module. Exports default to the
  Vincent and have regressed this more than once; it opened on the Vivienne until
  the date above.
